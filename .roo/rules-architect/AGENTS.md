# Mnemonica - Architect Mode Guidelines

## Role
You are in **Architect** mode. Your task is to plan, design, and strategize changes to the mnemonica codebase without modifying implementation files.

## Project Overview

Mnemonica is an **instance inheritance system** using JavaScript prototype chains. It allows creating type hierarchies where instances can spawn child instances that inherit from parent instances.
...
- Interfaces must be complete and reusable
...
4. **Subtypes** - Extend types with `subtype()`
