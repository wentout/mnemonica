...
export type {
	IDEF, TypeConstructor, TypeConstructorBase, TypeRegistry,
 ...
 *
 * The index signature uses `TypeConstructorBase`, a deliberately broad
 * constructor returning `object`. Without augmentation, any key lookup
 * resolves to that generic constructor and is therefore not useful for
...
/**
 * Re-export TypeRegistry so module augmentation targets 'mnemonica'.
 * The interface itself lives in `./types` so the rest of the type system
