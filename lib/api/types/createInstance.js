...
const getStack = (TypeName, existentInstance) => {
	...
	// if (!stack.length && existentInstance) {
	if (existentInstance) {
...
const InstanceCreator = function (existentInstance, type, args, chained) {
	...
	const stackAddition = chained ? existentInstance : null;

	const stack = getStack(TypeName, stackAddition);
