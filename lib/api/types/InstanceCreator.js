...
// const addProps = function (_proto) {
const addProps = function (proto) {
	...
	// _proto[Symbol.species] = proto;

};


const undefineParentSubTypes = function (proto) {
...
const proceedProto = function (proto) {
	
	const self = this;
	self.addProps(proto);
	self.strictChain && self.undefineParentSubTypes(proto);
