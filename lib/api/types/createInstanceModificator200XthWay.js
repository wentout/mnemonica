...
const CreateInstanceModificatorAncient200XthWay = function (ModificatorType, ModificatorTypePrototype, NamespaceName) {
	...
	const TripleSchemeClosure = function () {
		...
		const Mnemosyne = function () {
			...
			ModificatorType[SymbolConstructorName] = Mnemosyne.prototype;
			return ModificatorType;
