...
const CreateInstanceModificatorAncient200XthWay = function (ModificatorType) {
	...
	const Mnemosyne = function (...args) {
		...
		Object.entries(ModificatorTypePrototype).forEach((entry) => {
			...
			// checking for previous getters
			// TODO: warn about property re-definition
			// through the featured future prototype chain
			if (!inheritedInstance.constructor.prototype[name]) {
				inheritedInstance.constructor.prototype[name] = value;
			}
		});
