...
const CreateInstanceModificator = function (ModificatorType) {
	...
	// const typeName = ModificatorType[SymbolConstructorName];
	...
	const Mnemosyne = function (...args) {
		...
		// this[SymbolConstructorName] = typeName;
		// set ModificatorType.prototype inheritance
		Object.setPrototypeOf(ModificatorType.prototype, this);
		// produce itself modification
