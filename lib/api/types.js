...
// const defineFromFunctionFallback = function (TypeName, ConstructHandler = function () {}, proto = {}) {
// 	const types = this;
...
// 	odp(types, TypeName, {
// 		get () {
// 			const TypeCreationController = function (...args) {
// 				ConstructHandler.call(this, ...args);
// 				odp(this.constructor.prototype.constructor, 'name', {
// 					get () {
// 						return TypeName;
// 					},
// 					enumerable : true
...
// 				return this;
// 			};
// 			TypeCreationController.prototype = proto;
// 			odp(TypeCreationController.prototype, 'constructor', {
// 				get () {
// 					return TypeCreationController;
// 				}
